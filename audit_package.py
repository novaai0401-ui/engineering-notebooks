...
with tempfile.TemporaryDirectory(prefix='portable-',dir=runtime) as temporary:
    ...
    commands=[['labs/rag-flow/test_flow.py'],['labs/rag-flow/test_generation_recovery.py'],['run_notebook_labs.py','--book','29-databases-for-fullstack-and-ai'],['run_notebook_labs.py','--book','30-rag-patterns-and-user-defined-flows'],['test_study_server.py']]
